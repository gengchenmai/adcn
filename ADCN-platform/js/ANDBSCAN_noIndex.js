 ...
 * @returns {DBSCAN}
 */
function ANDBSCAN(dataset, epsilon, minPts, distanceFunction) {
  /** @type {Array} */
  this.dataset = [];
  /** @type {number} */
  this.epsilon = 1;
...
ANDBSCAN.prototype._ellipseRegionQuery = function(centerPointId) {
  ...
  var currentNeighbor = this.sortDistIDArray(distArray, centerPointId);
 ...
 * @access public
 */
ANDBSCAN.prototype.run = function(dataset, epsilon, minPts, distanceFunction) {
  this._init(dataset, epsilon, minPts, distanceFunction);
 ...
 * @access protected
 */
ANDBSCAN.prototype._init = function(dataset, epsilon, minPts, distance) {
