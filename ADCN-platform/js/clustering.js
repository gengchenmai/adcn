 ...
 * @returns {DBSCAN}
 */
function DBSCAN(dataset, epsilon, minPts, rTree, distanceFunction) {
  /** @type {Array} */
  this.dataset = [];
  /** @type {number} */
  this.epsilon = 1;
...
Gengchen Mai
*/
DBSCAN.prototype.kthNearestDistance = function(dataset, pointId, minPts) {
  var distancePtArray = [];
...
DBSCAN.prototype.bubbleSorting = function (array){
...
Gengchen Mai
*/
DBSCAN.prototype.kthNearestArray = function(dataset, minPts) {
 ...
 * @access public
 */
DBSCAN.prototype.run = function(dataset, epsilon, minPts, rTree, distanceFunction) {
 ...
 * @access protected
 */
DBSCAN.prototype._init = function(dataset, epsilon, minPts, rTree, distance) {
 ...
 * @returns {OPTICS}
 */
function OPTICS(dataset, epsilon, minPts, rTree, distanceFunction) {
  /** @type {number} */
  this.epsilon = 1;
  /** @type {number} */
  this.minPts = 1;
 ...
 * @access public
 */
OPTICS.prototype.run = function(dataset, epsilon, minPts, rTree, distanceFunction) {
  this._init(dataset, epsilon, minPts, rTree, distanceFunction);
  ...
  for(var i = 0; i < this.clusters.length; i++)
  {
    if(this.clusters[i].length > 1)
      finalCluster.push(this.clusters[i]);
  }
 ...
 * @access protected
 */
OPTICS.prototype._init = function(dataset, epsilon, minPts, rTree, distance) {
