 ...
 * @returns {DBSCAN}
 */
function AEDBSCAN(dataset, epsilon, minPts, distanceFunction) {
  /** @type {Array} */
  this.dataset = [];
  /** @type {number} */
  this.epsilon = 1;
 ...
 * @access public
 */
AEDBSCAN.prototype.run = function(dataset, epsilon, minPts, distanceFunction) {
  this._init(dataset, epsilon, minPts, distanceFunction);
 ...
 * @access protected
 */
AEDBSCAN.prototype._init = function(dataset, epsilon, minPts, distance) {
